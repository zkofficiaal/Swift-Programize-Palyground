...
//Strong Reference in Swift(by default strong)

// declare a class
class Employee1 {
    var name1: String
    var salary1: Int
    var colleague1: Employee1?

    // initializer
    init(name1: String, salary1: Int) {
        self.name1 = name1
    ...
    // deinitializer
    deinit {
        print("Memory Deallocated for \(name1)")
    }
}

var sabby1: Employee1? = Employee1(name1: "Sabby", salary1: 50000)
var cathy1: Employee1? = Employee1(name1: "Cathy", salary1: 45000)

// link colleagues
sabby1?.colleague1 = cathy1
cathy1?.colleague1 = sabby1
